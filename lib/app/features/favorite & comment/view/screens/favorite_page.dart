...
import 'package:al_raheeq_library/app/features/favorite%20&%20comment/view/widgets/comment_widget.dart';
import 'package:al_raheeq_library/app/features/favorite%20&%20comment/view/widgets/favority_widget.dart';
            ...
            () => Stack(
              children: [
                AnimatedPositioned(
                  ...
                  left: (favoriteController.selectedTabIndex.value * itemWidth),
                  top: 0,
                  child: Container(
                    width: itemWidth,
                    height: 40,
                      ...
                      child: ZoomTapAnimation(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: TextStyle(
                              color:
                                  favoriteController.selectedTabIndex.value == 1
                                      ? Colors.white
                      ...
                      child: ZoomTapAnimation(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: TextStyle(
                              color:
                                  favoriteController.selectedTabIndex.value == 0
                                      ? Colors.white
                                      : Theme.of(context).colorScheme.onPrimary,
                            ),
                          ),
